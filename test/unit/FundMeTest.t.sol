...
contract FundMeTest is Test {
    ...
    function testOwnerIsMsgSender() public view {
        // console.log("contract owner: ", fundMe.i_owner());
    ...
    function testFundFailsWithoutEnoughETH() public {
        vm.expectRevert(); // The next line shoud revert
        fundMe.fund();
    }
    ...
    function testFundUpdatesFundedDataStructure() public funded {
        ...
        // fundMe.fund{value: SEND_VALUE}();
        // Using modifier funded instead of the above 2 lines of code
    ...
    function testWithdrawFromMultipleFunders() public funded {
        ...
        for (uint160 i = startingFunderIndex; i < numberOfFunders; i++) {
            hoax(address(i), SEND_VALUE); // set balance of USER and send next TX by USER
            fundMe.fund{value: SEND_VALUE}(); // fund the contract by USER
        }
